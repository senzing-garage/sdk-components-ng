...
function addPackageJsonDependencies(): Rule {
  return (host: Tree, context: SchematicContext) => {
    const dependencies: NodeDependency[] = [
      ...
      { type: NodeDependencyType.Default, version: '~2.1.3', name: '@senzing/sdk-graph-components' },
      { type: NodeDependencyType.Default, version: '~2.2.0', name: '@senzing/sdk-components-ng' }
    ];
