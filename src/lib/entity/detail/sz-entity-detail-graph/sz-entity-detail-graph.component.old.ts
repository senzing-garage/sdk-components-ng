 ...
 */
@Component({
  selector: 'sz-old-entity-detail-graph',
  templateUrl: './sz-entity-detail-graph.component.old.html',
  styleUrls: ['./sz-entity-detail-graph.component.old.scss']
})
export class SzOldEntityDetailGraphComponent implements OnInit, OnDestroy {
