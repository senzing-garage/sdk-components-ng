...
export class SzHowRCNavComponent implements OnInit, OnDestroy {
    ...
    // ---------------------------------------- form parameters
    public filterByTextOrRecordId           = undefined;
    public filterByVirtualEntityCreation    = false;
    public filterByMergeInterimEntitites    = false;
    public filterByAddRecordtoVirtualEntity = false;
    public filterByLowScoringNames          = false;
    public filterByLowScoringAddresses      = false;
