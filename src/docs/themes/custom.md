...
body {
  ...
  --sz-search-button-clear-color: #FFFFFF;
  --sz-search-button-submit-font-size: 10px;
  --sz-search-button-submit-font-weight: normal;
  ...
  --sz-search-button-submit-border: 1px solid #0E2863;
  ...
  --sz-search-button-clear-font-weight: normal;
  ...
  --sz-entity-detail-section-line-height: 18px;
  ...
  --sz-entity-detail-section-border: 1px solid #808285;
  ...
  --sz-entity-detail-name-font-size: 20px;
  ...
  --sz-entity-detail-pill-color: #FFFFFF;
  --sz-entity-detail-pill-border-radius: 5px;
  /* special overrides for entity detail component view since it coexists with primary detail view */
  ...
  --sz-entity-graph-control-item-background-color: #fff;
