...
to start the Senzing REST API Server on the command line or with Docker.  You can also use
the [Senzing App Integration Scripts](https://github.com/Senzing/senzing-api-server/tree/master/app-scripts).
